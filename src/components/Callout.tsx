...
const styles: { [K in StyleType]: { [T in StyleAttributes]: string; }} = {
  note: {
    ...
    body:      cL('text-sky-800 prose-code:text-sky-900 dark:text-slate-300',
                'dark:prose-code:text-slate-300 prose-a:text-sky-900',
  ...
  warning: {
    ...
    body:      cL('text-amber-800 prose-code:text-amber-900 prose-a:text-amber-900',
                '[--tw-prose-underline:theme(colors.amber.400)]',
                'dark:[--tw-prose-underline:theme(colors.sky.700)]',
                '[--tw-prose-background:theme(colors.amber.50)]',
